...
<html lang="da">
    <head>
        ...
        <meta name="description" content="<?php echo $defaultDescription; ?>">
        ...
        <meta property="og:description" content="<?php echo $defaultDescription; ?>">
        ...
        <meta name="twitter:title" content="<?php echo $defaultTitle; ?>">
        <meta name="twitter:description" content="<?php echo $defaultDescription; ?>">
